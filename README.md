...
[Quick Start](#-getting-started) • [Wails Build](#-scripts) • [GitHub Repository](https://github.com/PAVAN2005-LAB/-SortMind-AI.git) • [User Manual](file:///C:/Users/LENOVA/OneDrive/Desktop/MICROSOFT%20INTERSHIP/docs/index.html) • [License](#-license)
...
1. Clone the repository and navigate to the project directory:
   ```bash
   git clone https://github.com/PAVAN2005-LAB/-SortMind-AI.git
   cd -SortMind-AI/smart-ai-organizer
   ```
